...
export default function Correct({ show }: { show: boolean }) {
  return (
    <div
      ...
      }ease-in-out duration-500 will-change-transform transition-transform w-full h-[100vh] flex flex-col items-center justify-center fixed top-0 z-[510] bg-[#1d502f] gap-10`}
    >
